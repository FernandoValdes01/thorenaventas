...
export const orders = pgTable('orders', {
  ...
  customDiscountRate: numeric('custom_discount_rate', { precision: 5, scale: 4 }).notNull().default('0'),
  customDiscountAmount: numeric('custom_discount_amount', { precision: 14, scale: 2 }).notNull().default('0'),
...
export const orderItems = pgTable('order_items', {
  ...
  customDiscountRate: numeric('custom_discount_rate', { precision: 5, scale: 4 }).notNull().default('0'),
  customDiscountAmount: numeric('custom_discount_amount', { precision: 14, scale: 2 }).notNull().default('0'),
  itemKind: varchar('item_kind', { length: 24 }).notNull().default('product'),
  promoComponents: text('promo_components').notNull().default('[]'),
